...
IMPULSE_SPEED_LATE_GUARD_1H_RANGE_MIN_BULL: float = 12.0
...
EMA_CROSS_ENABLED:   bool  = True   # включить/выключить режим impulse_cross
...
ENTRY_SCORE_MIN_15M: float = 45.0  # was 48.0 — Scout proposed twice, applied manually (inconclusive backtest but deliberate)
...
CLONE_SIGNAL_GUARD_MAX_SIMILAR: int = 9  # was 4 — 116 blocks in recent events: FLUX/ORDI blocked by clone guard  # scout:15.04.2026 was 8
