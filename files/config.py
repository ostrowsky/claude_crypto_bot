...
CLONE_SIGNAL_GUARD_MAX_SIMILAR: int = 6  # was 4 — 116 blocks in recent events: FLUX/ORDI blocked by clone guard
...
OPEN_SIGNAL_CLUSTER_CAP_15M_IMPULSE_MAX: int = 4   # was 2 — 149 blocks in recent events (ORDI, FLUX blocked)
