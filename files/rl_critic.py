...
class TradeExperience:
    ...
    # Bandit arm (contextual bandit trail_k/hold selection)
    bandit_arm:      Optional[int]   = None   # arm index chosen at entry
    bandit_info:     Optional[dict]  = None   # bandit debug info

    # Exit RL action taken
    exit_rl_action:  Optional[int]   = None   # 0=hold, 1=tighten, 2=exit
