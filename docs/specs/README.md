...
| [`signal-evaluator-integration`](./features/signal-evaluator-integration-spec.md) | Phase A shipped 2026-05-04 v2.9.0 | ZigZag-labeler + per-trade verdicts из Claude Skill. Wrapper переводит наш bot_events.jsonl схему в skill-формат. Phase B-D: backfill `label_sustained_uptrend`, bandit verdict-reward, EX1 ZigZag-potential. |
